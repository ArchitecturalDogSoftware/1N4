...
- `DISCORD_TOKEN` - The bot's Discord token, which is required to connect to their API. This can be generated by [creating a new application](https://discord.com/developers/applications).
